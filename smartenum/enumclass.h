...
\code
// Does not work within a namespace.  Arguments may not have initializer expressions.  Arguments may contain comments.
G3D_DECLARE_ENUM_CLASS(Day, SUNDAY = 1, MONDAY, TUESDAY, WEDNESDAY, THURSDAY, FRIDAY, SATURDAY);
...
...
\sa G3D_DECLARE_ENUM_CLASS_METHODS, G3D_DECLARE_ENUM_CLASS_HASHCODE, G3D::enumToJavaScriptDeclaration
*/
...
\
G3D_DECLARE_ENUM_CLASS_HASHCODE(ClassName);
