 ...
 * \class Cable
 *
 * \brief defines a length in cables.
 *
 * Cables (22 yards) defines a length in  the \a Conversion utility.
 *
 * \author Simon Meaden
 * \date   20 July 2016
 */

class CONVERSIONSHARED_EXPORT Cable : public QObject, public AbstractLengthConversion {
        Q_OBJECT
        Q_PLUGIN_METADATA( IID IConversionInterface_iid )
        Q_INTERFACES( Conversion::IConversionInterface )
    public:
        Cable( ) :
            AbstractLengthConversion( QStringLiteral("18288E25"),
