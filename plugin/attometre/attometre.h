 ...
 *
 * Attometres (or 10 \sup{-21} metres) defines a length in  the \a Conversion utility.
 *
 * \author Simon Meaden
 * \date   20 July 2016
 */

class CONVERSIONSHARED_EXPORT Attometre :
        public QObject,
    ...
    public:
        Attometre( ) :
            AbstractLengthConversion( QStringLiteral("1E6"),
                                      QStringLiteral("Attometre"),
                                      QStringLiteral("am"),
                                      tr("Attometre, 10<sup>-21</sup> metres.") ) {
        }
